package com.app.todolist.model.database;
...
import com.app.todolist.model.database.tables.TTodoList;
import com.app.todolist.model.database.tables.TTodoSubTask;
import com.app.todolist.model.database.tables.TTodoTask;
...
public class DBQueryHandler {
    ...
    public static void deleteTodoList(SQLiteDatabase db, TodoList todoList) {
        ...
        Log.i(TAG, deletedTasks + " tasks pdeleted");
    ...
    public static int putTaskInTrash(SQLiteDatabase db, TodoTask todoTask) {
        ...
        Log.i(TAG, removedSubTask + " subtasks deleted");
